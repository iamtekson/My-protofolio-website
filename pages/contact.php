        ...
        <div class="row">
            ...
            <div class="col-md-5 wow slideInRight">
                ...
                <form id="contact-form" method="post" action="/form.php">
                    ...
                    <div class="form-group">
                        <input name="email" type="email" class="form-control" value="" placeholder="Your E-mail"
                            required>
                    </div>
                    <div class="form-group">
...
<div class="container-fluid padding">
    <div class="row text-center">
        ...
        <div class="col-12 social">
            <a href="https://facebook.com/iamtekson" target="_blank"><i
                    class="fab fa-facebook wow rotateIn"></i></a>
            ...
            <a href="https://www.instagram.com/iamtekson/"><i class="fab fa-instagram wow rotateIn"
                    target="_blank"></i></a>
